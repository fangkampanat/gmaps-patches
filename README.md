...
3. [Add this repository to Morphe Manager](https://morphe.software/add-source?github=fangkampanat%2Fgmaps-patches), or manually add `https://github.com/fangkampanat/gmaps-patches` as a custom patch source.
